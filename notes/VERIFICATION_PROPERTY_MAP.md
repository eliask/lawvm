...
| Shared changed-path diff | mutation_boundary | src/lawvm/core/mutation_boundary.py | Open Law audit; reusable by frontends | No, primitive | Snapshot/op changed outside declared target region |
