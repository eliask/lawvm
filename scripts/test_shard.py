...
SHARD_PATTERNS: dict[str, tuple[str, ...]] = {
    ...
    "finland_replay_products_support": (
        ...
        "test_provision_state_consumer_contract.py",
    ),
    "finland_replay_rules": (
        ...
        "test_finland_scoped_section_resolver.py",
        "test_future_repeal.py",
    ...
    "tools_cli_debug": (
        ...
        "test_spec_ledger_fi_catalog.py",
    ...
    "tools_runtime_io": (
        ...
        "test_export_sql.py",
        "test_export_transition_graph.py",
