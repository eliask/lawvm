...
def compute_strict_profile_fingerprint(profile: "StrictProfile") -> str:  # type: ignore[name-defined]  # noqa: F821
...
def build_compile_metadata(
    *,
    graph: "ProvenanceGraph",  # type: ignore[name-defined]  # noqa: F821
    profile: "StrictProfile",  # type: ignore[name-defined]  # noqa: F821
    evidence_policy: "EvidencePolicyRegistry",  # type: ignore[name-defined]  # noqa: F821
    source_bundle_hash: str,
    interpretation_policy_fingerprint: Optional[str] = None,
    build_id: str = "",
    build_timestamp: Optional[datetime] = None,
