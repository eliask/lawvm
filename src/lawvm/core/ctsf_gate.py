    ...
    *,
    ...
    return {
        "_doc": (
            ...
            "replay_bug/unknown). 2026-07-08 EU payload-boundary repair: the "
            "32015R0340 Article 9 witness exposed that QUOT.S payload collection "
            "stopped at an inner quote around the defined term, dropping the "
            "operative definition tail for 32012R0923 Article 2 point 104. "
            "Matching the outer QUOT.START/QUOT.END pair fixed the deterministic "
            "payload loss (unknown returns to 0; 32012R0923 cnf_unsupported 23→10 "
            "and temporal_mismatch 36→35; corpus residual total 1043→1021) and "
            "persisted the non-gating typed_skip_bucket_counts census. 2026-07-08 "
            "EU ALINEA subparagraph-coordinate repair: the 32013R1022 → "
            "32010R1093 witness exposed that PARAG>ALINEA encoded legal "
            "subparagraphs as P/LIST/P/P blocks, so targets like "
            "article:1/paragraph:5/subparagraph:2 missed. The grafter now "
            "materializes those P/LIST/P groups as subparagraph coordinates when "
            "the post-list P is a new uppercase/digit-starting subparagraph, while "
            "lowercase post-list continuations remain flat (protecting 32022R2309 "
            "Articles 6/9). This closes 34 target_kind_label_absent skips "
            "(32010R1093 cnf_unsupported 117→83; corpus residual total "
            "1021→987) with billable residuals still 0. 2026-07-08 EU insert "
            "parent-prefix repair: the 32013R1022 → 32010R1093 witnesses "
            "32013R1022-1.11 and -1.24 showed that INSERT parent paths "
            "(article:8 and article:29/paragraph:2) existed under unnamed "
            "DIVISION wrappers, but exact body-root resolution rejected them as "
            "parent_unresolved/parent_scope_unresolved. INSERT now binds a "
            "unique requested parent suffix under its declared first scope, "
            ...
            "residuals still 0. 2026-07-08 EU point-of-article repeal repair: "
            "the 32011R0057 → 32009R0754 witness said 'Point (h) of Article 1 "
            "is deleted', but the broad whole-article repeal recognizer read "
            "the embedded Article 1 citation as the target and deleted the host "
            "article. The grammar now recognizes this source shape as a point "
            "repeal before whole-article repeal, preserving Article 1 for "
            "32012R1040 point j/k/l inserts and 32013R1182 point b/j repeals. "
            "This closes five 32009R0754 typed skips (cnf_unsupported 7→2; "
            "corpus residual total 902→897), billable residuals still 0. "
            "2026-07-08 EU paragraph-of-article replacement repair: the "
            "32011R1295 → 32009R1284 witness said 'Paragraph (1) of Article 4 "
            "is replaced', but the broad whole-article recognizer read the "
            "embedded Article 4 citation as the target and flattened the host "
            "article. The grammar now recognizes this source shape as a "
            "paragraph replacement before whole-article replacement, preserving "
            "Article 4 for 32013R0049 point g/h inserts. This closes two "
            "32009R1284 typed skips (cnf_unsupported 21→19; corpus residual "
            "total 897→895), billable residuals still 0. 2026-07-08 EU "
            "sole-annex target guard: the 32013R0517 → 32009R1284 witness said "
            "'The following Regulations are amended as set out in the Annex', "
            "which does not name a base-annex coordinate. The grammar now emits "
            "a typed annex_extraction_gap instead of minting an executable bare "
            "@supplements annex: target. This removes the empty_target_label "
            "typed skip (32009R1284 cnf_unsupported 19→18; corpus residual "
            "total 895→894), billable residuals still 0. 2026-07-08 EU "
            "annex-context insert root repair: the 32024R1143 → 32019R0787 "
            "witnesses insert points into Annex I, and lowering now roots "
            "annex-context NP insert targets in @supplements while replay "
            "resolves such inserts against the supplements tree when present. "
            "The frozen 32019R0787 bytes still lack Annex I, so the three "
            "skips remain non-billable cnf_unsupported but move from "
            "parent_unresolved to annex_lane_target_absent; corpus residual "
            "total remains 894, billable residuals still 0. 2026-07-08 EU "
            "quoted article-subtitle metadata repair: the 32013R1022 → "
            "32010R1093 witness exposed that quoted whole-article payloads "
            "included STI.ART subtitles (for example Articles 20a/49a/52a) in "
            "replay body text, while the EU grafter treats STI.ART like TI.ART "
            "as article metadata. Structural payload extraction now excludes "
            "STI.ART, moving 32010R1093 temporal_mismatch 546→431, with smaller "
            "same-family movements in 32008R0692 (70→69), 32012R0923 (35→28), "
            "and 32019R0787 (43→42); corpus residual total 894→770; billable "
            "residuals still 0 and typed-skip buckets unchanged. Regenerate "
            "with `uv run python "
