...
FINDING_REGISTRY: Dict[str, FindingSpec] = {f.code: f for f in (
    ...
    FindingSpec("ELAB.AMBIGUOUS_BINDING", "sparse_subsection_elaboration",
                ...
                ("ambiguity_resolution",), role="observation"),
    FindingSpec("ELAB.POSITIONAL_FALLBACK_BINDING", "sparse_subsection_elaboration",
                "ambiguity", "warn", "payload_normalize",
                "subsection slot label did not match the target; payload was bound by positional order",
                ("ambiguity_resolution",), role="observation"),
    FindingSpec("ELAB.POSITIONAL_FALLBACK_ORDER_MISMATCH", "sparse_subsection_elaboration",
                "ambiguity", "strict_fail", "payload_normalize",
                "positional-fallback payload slots disagree with declared target moment order (candidate mis-bind)",
                ("ambiguity_resolution", "strictness"), role="observation"),
    ...
    FindingSpec("BASE_UNNUMBERED_PEER_REPARENT", "source_normalize",
                ...
                ("comparative", "preservation"), role="observation"),
    FindingSpec("BASE_EMPTY_TRAILING_CHAPTER_ADOPTED", "base_source_analysis",
                "recovery", "info", "statute",
                "base statute declares an empty trailing chapter closed too early; trailing flat sections adopted into it",
                ("comparative", "preservation"), role="observation"),
    FindingSpec("BASE_TAIL_PROSE_ABSORB", "source_normalize",
                ...
                ("comparative", "preservation"), role="observation"),
    FindingSpec("BASE_DASH_BULLET_ITEM_CONTINUATION", "source_normalize",
                "recovery", "info", "statute",
                "base statute source normalization attached a dash-bullet peer as content on the preceding numbered item",
                ("comparative", "preservation"), role="observation"),
    ...
    FindingSpec("BASE_INTRO_LIST_TAIL_MOMENT_SPLIT", "source_normalize",
                ...
                ("comparative", "preservation"), role="observation"),
    FindingSpec("BASE_TREATY_PROTOCOL_MOMENT_SPLIT", "source_normalize",
                "recovery", "info", "statute",
                "base statute source normalization split a treaty protocol paragraph with explicit second-moment anaphora into peer subsections",
                ("comparative", "preservation"), role="observation"),
