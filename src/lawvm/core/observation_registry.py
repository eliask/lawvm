...
FINDING_REGISTRY: Dict[str, FindingSpec] = {f.code: f for f in (
    ...
    FindingSpec("PARSE.KUMOTAAN_RECYCLE_GUARD", "process_muutoslaki",
                ...
                ("parse_witness", "preservation"), role="observation"),
    FindingSpec("PARSE.PURE_KUMOTAAN_REPEAL_RECONSTRUCTED", "process_muutoslaki",
                "recovery", "warn", "kumotaan",
                "a repeal op was reconstructed from raw kumotaan johtolause because the typed pipeline produced no op for the target",
