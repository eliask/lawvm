...
_NESTING_ORDER = {
    ...
    "section": {"subsection", "omission", "heading", "num", "content", "crossHeading"},
    "subsection": {"intro", "content", "paragraph", "num", "hcontainer", "wrapUp", "omission", "crossHeading"},
    "division": {
        "division",
        "part",
        "chapter",
    ...
    "subparagraph": {"subparagraph", "item", "sentence", "heading", "num", "content", "intro", "wrapUp", "omission", "hcontainer"},
