...
from typing import TYPE_CHECKING, Any, List, Literal, Optional, Sequence, cast
...
# Parse lane (XML / IR document -> IRStatute) lives in grafter_parse; re-imported
# here verbatim so the public `from lawvm.estonia.grafter import X` surface is
# unchanged after the packaging split.
from lawvm.estonia.grafter_parse import (  # noqa: F401
    NS_BASE,
    _EE_DROP_LOIKE_TEKST_PLACEHOLDER_RULE,
    _EE_DROP_ORPHAN_APPENDIX_MARKER_RULE,
    _EE_DROP_REPEALED_RANGE_RESIDUE_RULE,
    _EE_HEADING_ORDINAL_RE,
    _EE_HTML_PARAGRAPH_NUMBERED_ITEMS_RULE,
    _EE_HTML_TABLE_NUMBERED_ITEMS_RULE,
    _EE_HTML_TABLE_TEXT_RULE,
    _EE_INLINE_ITEM_PARENTHESES_MARKER_GUARD_RULE,
    _EE_ITEM_LABEL_RE,
    _EE_ITEM_START_PATTERN,
    _EE_RT_INLINE_CHANGE_NOTE_RE,
    _EE_SECTION_LEVEL_INTRO_TO_FIRST_SUBSECTION_RULE,
    _EE_SECTION_LEVEL_REAVAHETUS_ITEMS_TO_FIRST_SUBSECTION_RULE,
    _EE_SINGLETON_EMPTY_SECTION_LABEL_RULE,
    _EE_SPACED_SUPERSCRIPT_SUBSECTION_MARKER_RULE,
    _EE_UNLABELED_LOIGE_CONTINUATION_RULE,
    _INLINE_TAGS,
    _RANGE_LABEL_RE,
    _appendix_html_payload_text,
    _attach_unlabeled_loige_continuation,
    _build_phantom_set,
    _canonicalize_singleton_empty_section_label,
    _collect_text,
    _detect_ns,
    _element_has_kehtetu_marker,
    _element_text_with_bold_section_boundaries,
    _expand_range_sections,
    _extract_appendix_marker,
    _extract_heading_ordinal_label,
    _extract_html_table_item_children,
    _extract_numbered_html_paragraph_item_children,
    _extract_numbered_html_table_row_items,
    _extract_reavahetus_intro_text,
    _extract_reavahetus_items,
    _extract_superscript_label,
    _find,
    _html_fragment_plain_text,
    _html_to_plain_text,
    _is_repealed_range_residue_text,
    _leading_appendix_marker,
    _loige_has_explicit_label,
    _looks_like_reavahetus_item_tail,
    _normalize_ee_statute_surface_text,
    _ns,
    _paragrahv_to_act_id,
    _parse_chapter,
    _parse_division,
    _parse_inline_item_children,
    _parse_inline_subsection_payload_nodes,
    _parse_item,
    _parse_section,
    _parse_subsection,
    _parse_subsection_item_payload,
    _parse_subsection_nodes,
    _section_html_table_text,
    _section_level_sisutekst_text,
    _sisuTekst_text,
    _sisuTekst_text_with_appendix_markers,
    _strip_rt_editorial_parentheticals,
    _strip_rt_inline_change_note,
    _subsection_uses_appendix_html,
    _tavatekst_text,
    _text,
    _title_text,
    _try_parse_int,
