...
_KNOWN_EE_RESIDUALS: dict[tuple[str, str], EEPairResidualInventory] = {
    ("124112016002", "127092023006"): EEPairResidualInventory(
        ...
        statute_title="Mahepõllumajanduse seadus",
        ...
        residuals=cast(tuple[EEResidualRecord, ...], (
            EEResidualRecord(
                ...
                evidence=(
                    "The only remaining chapter-level mismatch is inherited from § 10. "
                    "Source act 108122020001 globally replaces 'Põllumajandusamet' and "
                    "'Veterinaar- ja Toiduamet' with 'Põllumajandus- ja Toiduamet', "
                    "but explicitly excludes §§ 10 and 14 from that global rewrite. "
                    "No later in-range source clause applies the agency-collapse rewrite "
                    "to § 10; oracle 127092023006 nevertheless carries the collapsed "
                    "agency name in § 10(1)–(3)."
                ),
            ),
            EEResidualRecord(
                address="chapter:2/section:10",
                bucket="source_oracle_drift",
                evidence=(
                    "Source act 108122020001 excludes § 10 from the global "
                    "'Põllumajandusamet' / 'Veterinaar- ja Toiduamet' -> "
                    "'Põllumajandus- ja Toiduamet' rewrite. The same source only "
                    "deletes the tail phrase in § 10(1) ('vastavalt sellele, kumma "
                    "pädevuses ...'), and does not rewrite the agency phrase in "
                    "§ 10(1)–(3). Oracle 127092023006 applies the excluded agency "
                    "collapse in § 10 anyway."
                ),
            ),
            EEResidualRecord(
                address="chapter:2/section:10/subsection:1",
                bucket="source_oracle_drift",
                evidence=(
                    "Replay leaves 'Põllumajandusametile või Veterinaar- ja "
                    "Toiduametile' in § 10(1) after applying the source-backed "
                    "deletion of the competence-tail phrase. Source act 108122020001 "
                    "explicitly excluded § 10 from the global agency-collapse rewrite. "
                    "Oracle 127092023006 instead has 'Põllumajandus- ja Toiduametile'."
                ),
            ),
            EEResidualRecord(
                address="chapter:2/section:10/subsection:2",
                bucket="source_oracle_drift",
                evidence=(
                    "Replay leaves 'Põllumajandusametile või Veterinaar- ja "
                    "Toiduametile' in § 10(2). Source act 108122020001 explicitly "
                    "excluded § 10 from the global agency-collapse rewrite, and no "
                    "later in-range amendment applies that rewrite to § 10(2). Oracle "
                    "127092023006 nevertheless has 'Põllumajandus- ja Toiduametile'."
                ),
            ),
            EEResidualRecord(
                address="chapter:2/section:10/subsection:3",
                bucket="source_oracle_drift",
                evidence=(
                    "Replay leaves 'Põllumajandusametile või Veterinaar- ja "
                    "Toiduametile' in § 10(3). Source act 108122020001 explicitly "
                    "excluded § 10 from the global agency-collapse rewrite, and no "
                    "later in-range amendment applies that rewrite to § 10(3). Oracle "
                    "127092023006 nevertheless has 'Põllumajandus- ja Toiduametile'."
                ),
            ),
        )),
