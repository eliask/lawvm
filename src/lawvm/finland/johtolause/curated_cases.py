...
CURATED_CASES = [
    ...
    },
    {
        ...
        "text": ("muutetaan pykälien 1, 9, 45, 57, 66, 93 a, 95 ja 99 suomenkielinen sanamuoto"),
        "expected": [
            "M P 1",
            "M P 9",
            "M P 45",
    ...
    },
    {
        ...
        "text": ("muutetaan 23 §:n 8 ja 10 kohdan ruotsinkielinen sanamuoto, lisätään 2 §:ään uusi 25-35 kohta"),
        "expected": [
            "M P 23 1 8",
            "M P 23 1 10",
            "L P 2 1 25",
    ...
    },
    {
        ...
        "expected": ["L P 18 2", "L P 18 6", "L P 18 7", "L P 18 8", "L P 25a"],
        "features": {
            "verb_lisata",
            "insertion_pykala_ill",
            "insertion_law_level",
    ...
    },
    {
        ...
        "expected": ["M P L:1 2", "M L 3 o", "M P 3", "M P 4", "M P 5a"],
        "features": {"verb_muuttaa", "section_ref", "chapter_ref", "sub_ref_otsikko", "conj_target_list"},
    },
    {
    ...
    # ------------------------------------------------------------------
    {
        ...
        "expected": ["L P 14a"],
        "features": {"verb_lisata", "insertion_law_level", "letter_suffix", "uuden_gen_pykala"},
    },
    {
        ...
        "features": {"verb_lisata", "insertion_law_level", "letter_suffix", "conj_target_list", "uuden_gen_pykala"},
    },
    {
        "name": "insertion_law_level uuden range gen pykala",
        "text": "lisätään lakiin uuden 14b–14d §:n",
        "expected": ["L P 14b", "L P 14c", "L P 14d"],
        "features": {"verb_lisata", "insertion_law_level", "letter_suffix", "range_expansion", "uuden_gen_pykala"},
    },
    # ------------------------------------------------------------------
    ...
    },
    {
        ...
        "text": ("lisätään tartuntatautilakiin (1227/2016) väliaikaisesti uusi 16 a–16 g, 87 a ja 89 a § seuraavasti:"),
        "expected": [
            "L P 16a",
            "L P 16b",
            "L P 16c",
    ...
    },
    {
        ...
        "text": ("muutetaan 7 §:n numero 9:ksi, mainitun pykälän otsikko, 1 momentin 2 kohta ja 2 momentti"),
    ...
    # ==================================================================
    {
        ...
        "text": ("muutetaan sellaisena kuin se on laissa 100/2021 3 § ja 5 §"),
    ...
    },
    {
        ...
        "text": ("kumotaan sellaisena kuin se on muutettuna laissa 100/2021 ja mainitun lain 5 § 3 momentti"),
    ...
    # ==================================================================
    # Valio heading targets: "sen edellä oleva väliotsikko"
    # ==================================================================
    {
        "name": "valio heading simple: section ja sen valiotsikko",
        "text": "muutetaan 5 § ja sen edellä oleva väliotsikko",
        "expected": ["M P 5", "M P 5 o"],
        "features": {"valio_heading_target", "section_ref"},
    },
    {
        "name": "valio heading chain: section, valiotsikko, more sections",
        "text": "muutetaan 3 § sekä sen edellä olevan väliotsikon sanamuoto ja 7 §",
        "expected": ["M P 3", "M P 3 o", "M P 7"],
        "features": {"valio_heading_target", "section_ref", "conj_target_list"},
    },
    {
        "name": "valio heading pykalan: subsection + pykalan valiotsikko",
        "text": "muutetaan 10 §:n 2 momentti sekä pykälän edellä olevan väliotsikon sanamuoto",
        "expected": ["M P 10 2", "M P 10 o"],
        "features": {"valio_heading_target", "sub_ref_momentti"},
    },
    {
        ...
        "expected": ["M P 5 1", "M P 8"],
        "features": {"jolloin_move", "section_ref", "sub_ref_momentti", "conj_target_list"},
    },
    {
    ...
    # ------------------------------------------------------------------
    {
        ...
        "text": ("lisätään 13 §:n tilalle uusi 13 §, 15 §:ään uusi 4 momentti"),
        "expected": ["L P 13", "L P 15 4"],
        "features": {
            "verb_lisata",
            "insertion_pykala_ill",
            "section_reinstatement",
        },
    },
    {
    ...
    },
    {
        ...
        "expected": ["L P 26 3", "L P 26 5"],
        "features": {
            "verb_lisata",
            "insertion_pykala_ill",
            "provenance_skip",
            "jolloin_move",
            "anaphoric_uusi_momentti",
        },
    },
    # ------------------------------------------------------------------
    ...
    },
    {
        ...
        "text": ("lisätään 3 lukuun siitä lailla 200/2010 kumotun 8 §:n tilalle uusi 8 §, 4 lukuun uusi 9 a §"),
    ...
    },
    {
        ...
        "text": ("lisätään 12 §:n 2 momenttiin siitä lailla 500/2015 kumotun c kohdan tilalle uusi c kohta"),
        "expected": ["L P 12 2 c"],
        "features": {
            "verb_lisata",
            "insertion_momentti_ill",
    ...
    },
    {
        ...
        "text": ("lisätään 26 §:ään, sellaisena kuin se on osaksi laissa 1428/2011, uusi 3 momentti"),
        "expected": ["L P 26 3"],
        "features": {
            "verb_lisata",
            "insertion_pykala_ill",
    ...
    # ------------------------------------------------------------------
    {
        ...
        "text": (
            "lisätään asetuksen 7 c lukuun uusi 55 a § ja 55 b §, asetukseen uusi 115 a § ja 118 §:ään uusi 2 momentti"
        ),
        "expected": [
    ...
    },
    {
        ...
        "text": ("lisätään lain 3 lukuun uusi 10 a §, lakiin uusi 15 a §"),
        "expected": [
    ...
    # mukaisesti" (or "Eduskunnan päätöksen mukaisesti annetun lain mukaan"),
    # followed by the standard amendment verb phrase.
    #
    ...
    #   HE 2025/195 bill_1 (ympäristönsuojelulaki + rikoslaki)
    #   HE 2022/10 bill_1 (sosiaali- ja terveydenhuolto + pelastustoimi)
    #   HE 2024/50 bill_1 (arvonlisäverolaki)
    #   HE 2023/100 bill_1 (saamelaiskäräjälaki)
    # ------------------------------------------------------------------
    {
        "name": "he_enacting_clause_preamble_muutetaan_section_momentti (HE 2025/195 bill_1)",
        ...
        # 225 §:n 1 momentin 7 ja 8 kohta, sekä lisätään 225 §:n 1 momenttiin uusi
        # 10–12 kohta sekä 225 §:ään uusi 2 momentti, jolloin nykyinen 2–4 momentti
        # siirtyvät 3–5 momentiksi, seuraavasti:
        "text": (
            "Eduskunnan päätöksen mukaisesti muutetaan ympäristönsuojelulain (527/2014) "
    ...
    {
        "name": "he_enacting_clause_preamble_kumotaan_muutetaan_lisataan (HE 2023/100 bill_1 saamelaiskäräjät)",
        # Real HE 2023/100 enactingClause for saamelaiskäräjälaki (trimmed).
        # Per AGENTS.md §15: real-corpus regression pinned to this HE.
        "text": (
    ...
    {
        "name": "he_enacting_clause_preamble_simple_replace (HE 2022/10 bill_2)",
        # Real HE 2022/10 enactingClause — simple single-section replace.
        "text": (
...
def run_curated_tests(nlp=None, verbose: bool = False) -> bool:
    ...
    print(f"{'=' * 70}")
    print(
        f"Results: {passed}/{passed + failed} non-xfail passed, "
...
def main():
    ...
    parser.add_argument("--verbose", "-v", action="store_true", help="Show features and input for all cases")
