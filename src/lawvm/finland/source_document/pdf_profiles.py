...
# ---------------------------------------------------------------------------
# The neutral SourceDocumentIR → IRNode lowering now lives in the jurisdiction-
# neutral ``lawvm.ingest.lowering`` package (Track A of the two-level pipeline);
# re-exported here so existing ``pdf_profiles.source_document_to_ir_node``
# callers keep working. Only the FI-specific idiom classifier + finlex loader +
# HE heuristic stay in this module.
from lawvm.ingest.lowering import source_document_to_ir_node  # noqa: E402,F401
