...
def run_chain(grupi_id: str, label: str, archive) -> dict[str, int]:
    """Run replay quality over consecutive redaction pairs in one EE group."""
...
def main(args: "argparse.Namespace") -> None:
    ...
    grupi_ids = list(getattr(args, "grupi_ids", None) or known_statutes.keys())
    ...
    try:
        ...
        for gid in grupi_ids:
            ...
            for key in grand:
                grand[key] += chain_totals.get(key, 0)
