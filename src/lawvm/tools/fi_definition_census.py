"""CLI for Finland definition-entry grammar differential census."""
...
def _result_to_json(result: FamilyCensusResult) -> dict[str, Any]:
    ...
    return {
        "catalog_kind": "finland_definition_census",
...
def main(args: Namespace) -> None:
    ...
    if getattr(args, "json", False):
        ...
        payload["family_id"] = DEFINITION_FAMILY
