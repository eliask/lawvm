"""CLI for Finland scope-carrier grammar differential census."""
...
def _result_to_json(result: FamilyCensusResult) -> dict[str, Any]:
    ...
    return {
        "catalog_kind": "finland_scope_carrier_census",
...
def main(args: Namespace) -> None:
    result = run_scope_carrier_census(
    ...
    if getattr(args, "json", False):
        ...
        payload["family_id"] = SCOPE_CARRIER_FAMILY
