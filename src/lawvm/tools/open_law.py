    ...
    print(
        " ".join(
            (
                ...
                f"lifecycle_tombstoned={report.summary['lifecycle_tombstoned']}",
    ...
    print(
        " ".join(
            (
                ...
                f"lifecycle_tombstoned={pack.report.summary['lifecycle_tombstoned']}",
...
def _summary_consistency_issues(report_dir: Path, operation_records: tuple[Any, ...], finding_records: tuple[Any, ...]) -> list[str]:
    ...
    expected = {
        ...
        "lifecycle_tombstoned": _count_status(operation_records, "lifecycle_tombstoned"),
