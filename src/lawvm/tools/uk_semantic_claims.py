...
UK_OPERATION_FAMILY_PROOF_SEMANTICS = frozenset(
    {
        ...
        "definition_entry_replacement_boundary_claim",
        ...
        "mixed_structural_definition_repeal_split_boundary_claim",
        "mixed_structural_text_rewrite_split_boundary_claim",
        ...
        "non_textual_application_modification_overlay",  # FLAG(union-merge)
    }
)
