...
def test_us_excluded_billable_windows_convict():
    ...
    surfaces: title23:2020->2022 (2, down from 13 after §176's ``non- Federal``
    ...
    §102's structural-payload phrase swap, then 3 after §109's heading/body
    duplicate-anchor occurrence selector, then 2 after §126's article-variant
