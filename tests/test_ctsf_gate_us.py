...
def test_us_excluded_billable_windows_convict():
    ...
    surfaces: e.g. title35:2010->2012 (21 wrong materializations — the AIA-era patent
    window), title23:2020->2022 (13), title50:2022->2023 (11 wrong + unclassified). If a
    window's replay was fixed (0 billable), promote it into REAL_ANCHOR_US_CORPUS_WINDOWS
    (a preregistered move)."""
