    ...
    report = NZInstructionWorkQueueReport(
        ...
        rows=(
            ...
            NZInstructionWorkQueueRow(
                ...
                instruction_semantic_candidate_status=NZInstructionSemanticCandidateStatus.BLOCKED_PAYLOAD_WITNESS_NOT_AVAILABLE,
                instruction_semantic_candidate_family=NZInstructionSemanticCandidateFamily.NONE,
