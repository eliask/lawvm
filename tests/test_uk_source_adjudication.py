...
def test_classify_uk_replay_adjudication_bucket() -> None:
    cases = {
        ...
        "uk_replay_whole_act_text_patch_preimage_gap": "text_surface",
        ...
        "uk_replay_after_words_in_brackets_text_rewrite_applied": "nonblocking_observation",
        "uk_replay_whole_act_text_patch_applied": "nonblocking_observation",
...
def test_classify_uk_effect_at_end_full_stop_omission_insert_as_structural_sibling() -> None:
    pathology = classify_uk_effect_source_pathology(
        extracted_tag="P2",
        extracted_text=(
