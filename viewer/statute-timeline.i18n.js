...
const STR = {
    ...
    evidenceForAmendment: 'Tähän muutossäädökseen liittyvä evidenssi',
  ...
  en: {
    ...
    evidenceForAmendment: 'Evidence for this amending act',
  ...
  sv: {
    ...
    evidenceForAmendment: 'Evidens för denna ändringsförfattning',
    versionN: (i, n) => `version ${i}/${n}`,
