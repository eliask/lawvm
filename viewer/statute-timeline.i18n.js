...
const STR = {
    ...
    focusChangedTip: 'Sulje kaikki haarat paitsi valittuna päivänä muuttuneet kohdat ja niiden vanhemmat.',
    focusChangedNoneTip: 'Valittuna päivänä ei ole näkyviä tekstimuutoksia.',
  ...
  en: {
    ...
    focusChangedTip: 'Collapse every branch except provisions changed on the selected date and their ancestors.',
    focusChangedNoneTip: 'There are no visible text changes on the selected date.',
  ...
  sv: {
    ...
    focusChangedTip: 'Stäng alla grenar utom ställen som ändrades på det valda datumet och deras överordnade ställen.',
    focusChangedNoneTip: 'Det finns inga synliga textändringar på det valda datumet.',
